...
CIMGUI_API void ImGui_ImplVulkan_RenderDrawData(ImDrawData *draw_data,
...
CIMGUI_API VkDescriptorSet ImGui_ImplVulkan_AddTexture(
...
CIMGUI_API int ImGui_ImplVulkanH_GetMinImageCountFromPresentMode(
